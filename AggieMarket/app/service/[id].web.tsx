      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        {service.images?.length > 0 ? (
          <div style={{ width: "100%", height: 300 }}>
            <WaCarousel navigation={service.images.length > 1} pagination={service.images.length > 1} loop style={{ height: "100%" }}>
...
const styles = StyleSheet.create({
  ...
  imagePlaceholder: { width: "100%", height: 300, backgroundColor: "#f0f4ff", alignItems: "center", justifyContent: "center", borderBottomWidth: 1, borderBottomColor: colors.border, gap: 8 },
