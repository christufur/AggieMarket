      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        {listing.images?.length > 0 ? (
          <div style={{ width: "100%", height: 300 }}>
            <WaCarousel navigation={listing.images.length > 1} pagination={listing.images.length > 1} loop style={{ height: "100%" }}>
        ...
        <View style={styles.body}>
          ...
          <View style={styles.metaRow}>
            {listing.condition && (
              <View style={styles.chip}><Text style={styles.chipText}>{listing.condition}</Text></View>
            )}
            <View style={styles.chip}><Text style={styles.chipText}>{listing.category}</Text></View>
          </View>
...
const styles = StyleSheet.create({
  ...
  imagePlaceholder: { width: "100%", height: 300, backgroundColor: colors.bg, alignItems: "center", justifyContent: "center", borderBottomWidth: 1, borderBottomColor: colors.border },
  ...
  contactBtn: { backgroundColor: colors.ink, paddingVertical: 14, borderRadius: 10, alignItems: "center", marginTop: 8 },
